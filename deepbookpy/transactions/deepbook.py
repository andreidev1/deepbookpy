...
from deepbookpy.utils.config import (
    DeepBookConfig,
    FLOAT_SCALAR,
    DEEP_SCALAR,
    POOL_CREATION_FEE,
)
from deepbookpy.custom_types import (
...
class DeepBookContract:
    ...
    def place_limit_order(
        self, params: PlaceLimitOrderParams, tx: SuiTransaction
    ) -> SuiTransaction:
        """
        Place a limit order
    ...
    def place_market_order(
        self, params: PlaceMarketOrderParams, tx: SuiTransaction
    ) -> SuiTransaction:
        """
    ...
    def cancel_order(
        self, pool_key: str, balance_manager_key: str, order_id: str, tx: SuiTransaction
    ) -> SuiTransaction:
        """
    ...
    def cancel_all_orders(
        self, pool_key: str, balance_manager_key: str, tx: SuiTransaction
    ) -> SuiTransaction:
        """
    ...
    def add_deep_price_point(
        self, target_pool_key: str, reference_pool_key: str, tx: SuiTransaction
    ) -> SuiTransaction:
        """
    ...
    def get_order(
        self, pool_key: str, order_id: str, tx: SuiTransaction
    ) -> SuiTransaction:
        """
        Gets an order
        ...
        tx.move_call(
            ...
            arguments=[ObjectID(pool["address"]), SuiU128(order_id)],
            type_arguments=[base_coin["type"], quote_coin["type"]],
        )
    ...
    def get_orders(
        self, pool_key: str, order_ids: list[str], tx: SuiTransaction
    ) -> SuiTransaction:
        """
    ...
    def mid_price(self, pool_key: str, tx: SuiTransaction) -> SuiTransaction:
        ...
        tx.move_call(
            ...
            arguments=[ObjectID(pool["address"]), ObjectID(CLOCK)],
            type_arguments=[base_coin["type"], quote_coin["type"]],
        )
    ...
    def whitelisted(self, pool_key: str, tx: SuiTransaction) -> SuiTransaction:
        ...
        tx.move_call(
            ...
            arguments=[ObjectID(pool["address"])],
            type_arguments=[base_coin["type"], quote_coin["type"]],
        )
    ...
    def get_quote_quantity_out(
        self, pool_key: str, base_quantity: int, tx: SuiTransaction
    ) -> SuiTransaction:
        """
    ...
    def get_base_quantity_out(
        self, pool_key: str, quote_quantity: int, tx: SuiTransaction
    ) -> SuiTransaction:
        """
    ...
    def get_quantity_out(
        self, pool_key: str, base_quantity: int, quote_quantity: int, tx: SuiTransaction
    ) -> SuiTransaction:
        """
        Get the base quantity out for a given quote quantity in
    ...
    def account_open_orders(
        self, pool_key: str, manager_key: int, tx: SuiTransaction
    ) -> SuiTransaction:
        """
        ...
        tx.move_call(
            ...
            arguments=[ObjectID(pool["address"]), ObjectID(manager["address"])],
            type_arguments=[base_coin["type"], quote_coin["type"]],
        )
    ...
    def get_level2_range(
        ...
        tx.move_call(
            ...
            arguments=[
                ObjectID(pool["address"]),
                SuiU64(
                    (price_low * FLOAT_SCALAR * quote_coin["scalar"])
                    / base_coin["scalar"]
                ),
                SuiU64(
                    (price_high * FLOAT_SCALAR * quote_coin["scalar"])
                    / base_coin["scalar"]
                ),
                SuiBoolean(is_bid),
                ObjectID(CLOCK),
    ...
    def get_level2_ticks_from_mid(
        self, pool_key: str, tick_from_mid: int, tx: SuiTransaction
    ) -> SuiTransaction:
        """
    ...
    def get_pool_id_by_assets(
        self, base_type: str, quote_type: str, tx: SuiTransaction
    ) -> SuiTransaction:
        """
        ...
        tx.move_call(
            ...
            arguments=[ObjectID(self.__config.REGISTRY_ID)],
    ...
    def swap_exact_base_for_quote(
        ...
        base_coin_input = (
            ...
            else coin_with_balance(sender_with_result, base_coin["type"], quote, tx)
        )

        deep_coin_test = (
            params.deep_coin
            if params.deep_coin is not None
            else coin_with_balance(sender_with_result, deep_coin_type, deep_amount, tx)
        )
    ...
    def swap_exact_quote_for_base(
        ...
        quote_coin_input = (
            params.quote_coin
            if params.quote_coin is not None
            else coin_with_balance(
                sender_with_result,
                quote_coin["type"],
                round(quote_amount * quote_coin["scalar"]),
                tx,
            )
        )
        ...
        deep_coin = (
            ...
            if params.deep_coin is not None
                ...
                sender_with_result, deep_coin_type, round(deep_amount * DEEP_SCALAR), tx
            )
        )
    ...
    def account(
        self, pool_key: str, manager_key: str, tx: SuiTransaction
    ) -> SuiTransaction:
        """
        ...
        tx.move_call(
            ...
            arguments=[ObjectID(pool["address"]), ObjectID(manager_id)],
            type_arguments=[base_coin["type"], quote_coin["type"]],
        )
    ...
    def create_permisionless_pool(
        ...
        deep_coin_input = (
            deep_coin
            if deep_coin is not None
            else coin_with_balance(
                sender_with_result, deep_coin_type, POOL_CREATION_FEE, tx
            )
        )
