...
class FlashLoanContract:
    ...
    def borrow_base_asset(
        self, pool_key: str, borrow_amount: int, tx: SuiTransaction
    ) -> SuiTransaction:
        """
    ...
    def return_base_asset(
        ...
        base_coin_return = tx.split_coin(
            coin=base_coin_input, amounts=[round(borrow_amount * borrow_scalar)]
        )
        tx.move_call(
    ...
    def return_quote_asset(
        self,
        pool_key: str,
        borrow_amount: int,
        quote_coin_input: str,
        flash_loan: str,
        tx: SuiTransaction,
    ) -> SuiTransaction:
        """
        ...
        quote_coin_return = tx.split_coin(
            coin=quote_coin_input, amounts=[round(borrow_amount * borrow_scalar)]
        )
